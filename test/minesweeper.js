...
describe('Minesweeper', function () {
    ...
    describe('#constructor()', function () {
        it('new minefield should be in ready state and duration is 0', function () {
            ...
            minesweeper.state.should.equal(GameState.Created);
            minesweeper.isStarted().should.equal(false);
    ...
    describe('#reveal()', function() {
        it('first reveal should change status to Running', function() {
            ...
            minesweeper.isStarted().should.equal(true);
        });
        ...
        it('revealing all should end game successfully', function() {
            ...
            minesweeper.state.should.equal(GameState.Cleared);
            minesweeper.isOver().should.equal(true);
        });
